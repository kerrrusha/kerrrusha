...
💻 My development experience for educational purposes includes working in team with an Agile methodology. As a rule, I had the position of a Team Lead. Work experience for commercial purposes - from 09.2022 on the position of *Java Software Engineer* (writing web scrapers), in *DataOx* company. Two months later, from 11.2022, in the same company, I was offered a contract for a year (develop of new software and support of existing).
